...
const App = () => {
  ...
  const INITIAL_URL = `https://sharp-link-digital.site/`;
  const URL_IDENTIFAIRE = `58xtT3Rf`;
  ...
  OneSignal.initialize('8bcaa7cc-3cc3-4e5a-b29e-766c375ad9af');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-18T08:08:00'); //дата з якої поч працювати webView
      ...
      {!isLoading ? (
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            ...
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./Assets/img/222.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
